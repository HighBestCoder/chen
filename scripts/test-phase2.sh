...
tests=(
  TestQaConnectionRejection TestQaSessionRpc TestQaSessionAuthorization TestQaRun260911
  ...
  TestS07AuditRpc TestS07AuditBoundaries TestS07AuditOutbox
  ...
  TestDataViewSelection TestDataViewStateBoundaries TestMongoExecutionBoundaries TestMongoCommandParser TestMongoQueryLoader TestMongoRiskControl TestMongoAuditCoverage
