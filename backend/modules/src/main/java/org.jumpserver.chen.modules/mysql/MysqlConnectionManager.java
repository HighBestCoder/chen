...
public class MysqlConnectionManager extends BaseConnectionManager {
    ...
    private static final String jdbcUrlTemplate = "jdbc:mysql://${host}:${port}/${db}?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=CONVERT_TO_NULL&tinyInt1isBit=false";
